...
###############################################################
### prepare preloaded WHO shapefile
###############################################################
...
### setwd('...') where the raw unzipped WHO boundary files are stored

# 'Central African Republic' (only 1994-1995 or MICs)
# 'Guinea-Bissau', ? 'Guinea?



###############################################################
### subset to WHO countries and match
###############################################################
...
if(FALSE){
  ...
  #adm2.link.all <- read.csv("E:/rshiny_history/SurveyPrevRShiny_0511/WHO_admin_names.csv", fileEncoding = "Windows-1252")
